...
public class aMainRun {
	...
	public static void runConversionWithOutputDirectory(String SFDCCaseNumber, String InstanceToExecute,
		...
		System.out.println("Instance to Execute: " + InstanceToExecute);

		// DO NOT MODIFY NEXT FIVE STRINGS
		String DEV = "https://dsr.odm.apps.dev/"; // DEV Endpoint
		String QA = "https://dsr.odm.str/"; // QA Endpoint
		String PROD = "https://dsr.odm.prod/"; // PROD Endpoint
		String EmpCRA = "DecisionService/rest/v1/___RuleApp/"; // _ RuleApp
		String EmpCRS = "___Rules/"; // _ RuleSet
		String HPCRA = "DecisionService/rest/v1/__HealthPlansRuleApp/"; // Health Plan RuleApp
		String HPCRS = "__HealthPlansRule/"; // Health Plan RuleSet

		String JSONRequestFolderPath = "C:/Development/CRDTesting/JSONRequestFilesFolder/";
		//String JSONRequestFolderPath = "C:/Users/Z326059/OneDrive - _ Health/_/CRD Testing Code/JSONRequestFiles";
		...
		System.out.println("BaseURL selected: " + baseUrl);
		
		String apiUrl = baseUrl + (apiType.equals("_") ? EmpCRA : HPCRA) + RuleAppVersion + "/"
				+ (apiType.equals("_") ? EmpCRS : HPCRS) + RuleSetVersion;
