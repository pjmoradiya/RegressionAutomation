...
public class aMainRun {
    ...
    private static void processJsonRequest(String jsonFilePath, String apiUrl, String outputDirectory,
                                           String formattedDate, String SFDCCaseNumber, String InstanceToExecute,
                                           String TestingVersion, boolean generateExcel) {
        ...
        String excelFileName = SFDCCaseNumber + "_" + InstanceToExecute + "_CRD_" + baseFileName + "_"
                               + formattedDate + "_v" + TestingVersion + ".xlsx";
